...
from src.backend.repositories.auth_repository import AuthRepository
from src.backend.repositories.bid_repository import BidRepository
from src.backend.repositories.image_repository import ImageRepository
